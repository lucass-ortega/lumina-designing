...
const services: Service[] = [
  {
    ...
    copy: "Diseñamos sitios modernos, rápidos y estratégicos, pensados para que tu negocio se vea profesional y genere oportunidades reales.",
    bullets: ["Landing pages", "Sitios corporativos", "Diseño responsive", "Optimización de conversión"],
    image: illusWeb,
    accent: "blue",
  },
  {
    ...
    copy: "Optimizamos tu sitio para que Google entienda tu negocio y tus potenciales clientes puedan encontrarte cuando buscan lo que ofrecés.",
    bullets: ["SEO técnico y on-page", "Estructura y contenido", "Google Search Console", "Optimización de velocidad"],
  ...
  },
  {
    num: "03",
    tag: "Meta Ads",
    title: "Convertí publicidad en ventas.",
    copy: "Creamos campañas estratégicas en Instagram y Facebook para atraer personas interesadas y convertirlas en clientes.",
    bullets: ["Configuración de Pixel", "Creación de campañas", "Segmentación de audiencias", "Optimización de conversiones"],
    image: illusSeo,
    accent: "blue",
  },
  {
