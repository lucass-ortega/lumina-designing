...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Lumina Design — Sistemas digitales que encienden tu negocio" },
      { property: "og:description", content: "Diseño, desarrollo y automatización de alto impacto para marcas que quieren crecer." },
